...
// DecodeDelta returns null entirely when the chunk carries no applicable delta or usage.
public sealed record StreamDelta(string? Content, string? Reasoning, MessageUsage? Usage = null);
